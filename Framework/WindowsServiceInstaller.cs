...
namespace BlackRabbit.WindowsService.DebuggableService.Framework
{
	...
	public partial class WindowsServiceInstaller : Installer
	{
		...
		{
			ConsoleHarness.WriteToConsole(ConsoleColor.White, $"Installing service {Configuration.Name}.");
		...
		{
			ConsoleHarness.WriteToConsole(ConsoleColor.White, $"Un-Installing service {Configuration.Name}.");
		...
		{
			ConsoleHarness.WriteToConsole(ConsoleColor.White, $"Rolling back service {Configuration.Name}.");
